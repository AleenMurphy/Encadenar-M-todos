...
usuario1.hacer_depósito(100).hacer_depósito(200).hacer_depósito(300).hacer_retiro(50).mostrar_balance_usuario()

# Usuario 2 realiza depósitos y giros
usuario2.hacer_depósito(200).hacer_depósito(200).hacer_retiro(10).hacer_retiro(5).mostrar_balance_usuario()

# Usuario 3 realiza depósitos y giros
usuario3.hacer_depósito(300).hacer_retiro(20).hacer_retiro(10).hacer_retiro(50).mostrar_balance_usuario()
